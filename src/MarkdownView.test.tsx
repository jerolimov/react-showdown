...
| A2       | B2       |
`;
    const html = renderHTML({ markdown, options: { tables: true } });
...
| A2       | B2       |
`;
    const html = renderHTML({ markdown, flavor: 'github' });
...
| A2       | B2       |
`;
    const html = renderHTML({ markdown, flavor: 'original' });
  ...
  it('render text emojies', () => {
    ...
    const html = renderHTML({ markdown, options: { emoji: true } });
